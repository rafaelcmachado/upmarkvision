	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('img/bg.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" action="ope.php" id="formlogin" name="formlogin">
					...
					<span class="login100-form-title p-b-34 p-t-27">
  					...
  					<div class="wrap-input100 validate-input" data-validate = "Coloque o Login">
